...
Frequency support email: `frequencyapp.support@gmail.com`
...
2. Terms of Use (EULA) missing from the **app description** even when a privacy URL is filled in.
3. In-app purchase / subscription products stuck on **Missing Metadata** or **Developer Action Needed** (review screenshot, localized display name, or subscription-group localization).
4. Guideline 3.1.2 — Privacy and Terms links missing **inside the iOS app** (paywall or settings). This repo cannot add those in-app buttons.
